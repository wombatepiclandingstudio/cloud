/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv worker-configuration.d.ts` (hash: 7449dd875d4d2143655db8497181d8bd)
// Runtime types generated with workerd@1.20260603.1 2025-09-15 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	TOKEN_CACHE: KVNamespace;
	HYPERDRIVE: Hyperdrive;
	NEXTAUTH_SECRET: SecretsStoreSecret | string;
	SCM_SESSION_CAPABILITY_ENCRYPTION_KEY: SecretsStoreSecret;
	BITBUCKET_CLIENT_ID: SecretsStoreSecret | string;
	BITBUCKET_CLIENT_SECRET: SecretsStoreSecret | string;
	BITBUCKET_OAUTH_CREDENTIAL_ACTIVE_KEY_ID: SecretsStoreSecret | string;
	...
	BITBUCKET_OAUTH_CREDENTIAL_ACTIVE_PUBLIC_KEY: string;
	BITBUCKET_OAUTH_CREDENTIAL_ACTIVE_PRIVATE_KEY: string;
}
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		SCM_SESSION_CAPABILITY_ENCRYPTION_KEY: SecretsStoreSecret;
		BITBUCKET_CLIENT_ID: SecretsStoreSecret;
		BITBUCKET_CLIENT_SECRET: SecretsStoreSecret;
		BITBUCKET_OAUTH_CREDENTIAL_ACTIVE_KEY_ID: SecretsStoreSecret;
		...
		BITBUCKET_OAUTH_CREDENTIAL_ACTIVE_KEY_ID: string;
		BITBUCKET_OAUTH_CREDENTIAL_ACTIVE_PUBLIC_KEY: string;
		BITBUCKET_OAUTH_CREDENTIAL_ACTIVE_PRIVATE_KEY: string;
	}
