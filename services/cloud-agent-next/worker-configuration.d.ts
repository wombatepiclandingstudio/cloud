/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 34a9a79845e310ce4d99ebec7c8db838)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_LITE_APP_SLUG" | "GITHUB_LITE_APP_BOT_USER_ID" | "SANDBOX_TRANSPORT" | "R2_ATTACHMENTS_BUCKET" | "BACKUP_BUCKET_NAME" | "CLOUDFLARE_R2_ACCOUNT_ID" | "PER_SESSION_SANDBOX_ORG_IDS" | "MANAGED_SCM_CONTAINMENT_ORG_IDS" | "REPO_SNAPSHOT_ORG_IDS" | "NEXTAUTH_SECRET" | "KILO_SESSION_INGEST_URL" | "WORKER_URL" | "WS_ALLOWED_ORIGINS" | "KILOCODE_BACKEND_BASE_URL" | "KILO_OPENROUTER_BASE" | "INTERNAL_API_SECRET" | "R2_ENDPOINT" | "R2_ATTACHMENTS_READONLY_ACCESS_KEY_ID" | "R2_ATTACHMENTS_READONLY_SECRET_ACCESS_KEY" | "AGENT_ENV_VARS_PRIVATE_KEY" | "GITHUB_APP_ID" | "GITHUB_APP_PRIVATE_KEY" | "CLI_TIMEOUT_SECONDS" | "REAPER_INTERVAL_MS" | "STALE_THRESHOLD_MS" | "PENDING_START_TIMEOUT_MS" | "GITHUB_APP_SLUG" | "GITHUB_APP_BOT_USER_ID" | "GITHUB_LITE_APP_ID" | "GITHUB_LITE_APP_PRIVATE_KEY" | "KILOCODE_SANDBOX_BACKEND_BASE_URL" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY">> {}
}
declare module "*.sql" {
	const value: string;
